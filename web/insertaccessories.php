...
$sql = "INSERT INTO accessories (p_name, p_price, p_img, p_color, p_category, p_catagioes, p_details) VALUES ('$p_name','$p_price','$p_img',' $p_color', ' $p_category', '$p_details')";
echo $sql;
